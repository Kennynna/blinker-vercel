...
function VerticalIcon(): React.JSX.Element {
  return (
    ...
    >
      <Box sx={{ borderRight: '0.0625rem dashed var(--mui-palette-divider)', px: 1, py: 0.5 }}>
        <Stack spacing={1}>
          <Box
            sx={{ bgcolor: 'var(--mui-palette-primary-main)', borderRadius: '2px', height: '0.25rem', width: '26px' }}
          />
          <Box
            sx={{
  ...
  return (
    ...
    >
      <Stack
        direction="row"
        spacing={1}
        sx={{ alignItems: 'center', borderBottom: '0.0625rem dashed var(--mui-palette-divider)', px: 1, py: '0.25rem' }}
      >
        <Box
          sx={{ bgcolor: 'var(--mui-palette-primary-main)', borderRadius: '2px', height: '0.25rem', width: '1rem' }}
        />
        <Box
          sx={{
            bgcolor: 'var(--mui-palette-background-level3)',
