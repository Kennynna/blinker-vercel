...
import { Discount } from '../../drawer-info-item';
...
export const eventsCard = [
  { date: '13 июля · СР', events: [1, 2, 3] },
  { date: '17 июля · ВТ', events: [1, 2, 3] },
  { date: '26 ноября · ПТ', events: [1, 2, 3] },
];
  ...
  return (
    <>
      <Wrapper>
        ...
        <TextWrapper>
          <EventName>5 км от вас</EventName>
          <EventTime>Название ресторана в 2 строки</EventTime>
          <EventName>Ресторан · ₽₽₽</EventName>
        </TextWrapper>
      </Wrapper>
    </>
  );
