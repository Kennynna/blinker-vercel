...
export default function BottomDrawer() {
  ...
  const drawerContent = () => (
    ...
    >
      ...
      >
        Благодаря вашей заметке пользователи могут узнать интересные факты, полезные советы или ваше мнение о месте
      </p>
  ...
  return (
    <div style={{width: '100%'}}>
      ...
      <DrawerButton onClick={toggleDrawer(true)}>Далее</DrawerButton>
