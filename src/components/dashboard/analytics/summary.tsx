    ...
    <Card>
      ...
      >
        <Stack
          spacing={1}
          sx={{
            borderRight: { xs: 'none', md: '0.0625rem solid var(--mui-palette-divider)' },
            borderBottom: { xs: '0.0625rem solid var(--mui-palette-divider)', md: 'none' },
            pb: { xs: 2, md: 0 },
          }}
        >
        ...
        <Stack
          spacing={1}
          sx={{
            borderRight: { xs: 'none', lg: '0.0625rem solid var(--mui-palette-divider)' },
            borderBottom: { xs: '0.0625rem solid var(--mui-palette-divider)', md: 'none' },
            pb: { xs: 2, md: 0 },
          }}
        >
