        ...
        <Stack spacing={3} sx={{ flex: '1 1 auto', overflowY: 'auto' }}>
          <Stack spacing={3}>
            ...
            <Card sx={{ borderRadius: 1 }} variant="outlined">
              <PropertyList divider={<Divider />} sx={{ '--PropertyItem-padding': '0.75rem 1.5rem' }}>
                {(
                  [
                        ...
                        <Stack direction="row" spacing={2}>
                          ...
                          >
                            <Box
                              ...
                              sx={{ borderRadius: '3.125rem', height: 'auto', width: '2.1875rem' }}
                            />
                          </Avatar>
                          <div>
          ...
          <Stack spacing={3}>
            ...
            <Card sx={{ borderRadius: 1 }} variant="outlined">
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', p: 3 }}>
                <Stack spacing={2} sx={{ width: '18.75rem', maxWidth: '100%' }}>
