...
function getContainedVars(color: string): Record<string, string> {
  return {
    ...
    '--Button-containedStroke': `inset 0px 0px 0px 0.0625rem var(--mui-palette-${color}-dark), inset 0px 0.125rem 0px 0px rgba(255, 255, 255, 0.16)`,
  };
}
...
export const MuiButton = {
  ...
  styleOverrides: {
    ...
    contained: {
      ...
      '&:hover': {
        boxShadow:
          'var(--mui-shadows-8), var(--Button-containedStroke), inset 0px 0.375rem  0.625rem 0px rgba(255, 255, 255, 0.10)',
      },
      '&:active': { backgroundImage: 'var(--Button-containedBg)' },
      '&:focus-visible': { boxShadow: 'var(--mui-shadows-8)', outlineOffset: '0.0625rem' },
    ...
    sizeSmall: { '--Button-minHeight': '32x', fontSize: '0.8125rem', lineHeight: '1.5rem' },
    sizeMedium: { '--Button-minHeight': '40x', fontSize: '0.875rem', lineHeight: '28px' },
    sizeLarge: { '--Button-minHeight': '48x', fontSize: '0.9375rem', lineHeight: '2rem' },
  },
